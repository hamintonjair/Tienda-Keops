						...
						<div class="wrap-table-shopping-cart">
							...
							<?php 
								foreach ($_SESSION['arrCarrito'] as $producto) {
									...
									$totalProducto2 = $producto['USD'] * $producto['cantidad'];
									$subtotal2 += $totalProducto2;
						...
						<div class="flex-w flex-t bor12 p-b-13">
							...
							<div class="size-209">
								<span id="subTotalCompra" class="mtext-110 cl2">
									<?= SMONEY.formatMoney($subtotal);  echo "-"?>								
								</span>
								<span id="subTotalCompra2" class="mtext-110 cl2">									
									<?= CURRENCY.formatMoney($subtotal2) ?>
								</span>
							</div>
							...
							<div class="size-209">
								<span class="mtext-110 cl2">								
									<?= CURRENCY.formatMoney($costo_evio ) ?>
								</span>
							</div>
						</div>
						<div class="flex-w flex-t p-t-27 p-b-33">
							...
							<div class="size-209 p-t-1">
								<span id="totalCompra" class="mtext-110 cl2">									
									<?= CURRENCY.formatMoney($subtotal2 + $costo_evio ); ?>								
								</span>								
							</div>
						</div>
