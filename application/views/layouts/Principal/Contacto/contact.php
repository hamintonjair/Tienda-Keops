...
for($i=0; $i < count( $contactos); $i++){
     $banner = $contactos[$i]->portada;
	 $idpagina = $contactos[$i]->idpost;
	 $contenido = $contactos[$i]->contenido;
	 $contacto = $contactos[$i]->titulo;
}
			...
			<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
				<form id="frmContacto">
					...
					<div class="bor8 m-b-20 how-pos4-parent">
						...
						<img class="how-pos4 pointer-none" src="<?= base_url() ?>assets/Template/Cliente/assets2/images/icons/icon-email.png" alt="ICON" style="width: 28px;">
					</div>
					...
					<div class="bor8 m-b-20 how-pos4-parent">
						...
						<img class="how-pos4 pointer-none" src="<?= base_url() ?>assets/Template/Cliente/assets2/images/icons/icon-email.png" alt="ICON">
					</div>
				...
				<div class="flex-w w-full p-b-42">
					...
					<div class="size-212 p-t-2">
						...
						<p class="stext-115 cl1 size-213 p-t-18">
							...
							<a class="" href="tel:<?=   $telefono  ?>"><?=   $telefono  ?></a>
						</p>
					</div>
				</div>
