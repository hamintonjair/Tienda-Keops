    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Dashboard <small>Tienda Virtual</small></h1>
        </div>
        ...
        <div class="col-md-6">
          <div class="tile">
            <div class="container-title">
              ...
              <tbody>
                <?php 
                    if(count($productosTen) > 0 ){
                      foreach ($productosTen as $producto) {
                 ?>
                <tr>
                  <td><?= $producto->idproducto ?></td>
                  <td><?= $producto->nombre?></td>
                  <td><?= SMONEY. formatMoney($producto->precio) ?></td>
                  <td><a href="<?= base_url() ?>tienda/productosView/<?= $producto->idproducto.'/'.$producto->ruta ?>" ><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                </tr>
                <?php } 
                  } ?>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="container-title">
              <h3 class="tile-title">Compra por mes</h3>
              <div class="dflex">
